// // src/components/admin/ProblemList.jsx
...
//               <li key={prob._id}>
//                 <button 
//                   className={`p-4 rounded-none ${prob._id === selectedProblemId ? 'active' : ''}`}
      ...
      <div className="card-body p-0 overflow-y-auto">
        ...
        {!isLoading && !error && (
          <ul className="menu p-0">
            {problems.map((prob) => (
              <li key={prob._id}>
                {/* Instead of a button that *contains* a div, we make the button
                  a flex container itself for more control.
                */}
                <button 
                ...
                >
                  ...
                  {/* This is the trash icon from your screenshot.
                    It only appears if the item is selected.
                    The delete *logic* is still in your form, which is safer.
                  */}
